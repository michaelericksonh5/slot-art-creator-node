...
`/slot-step-06` via `WHEEL_TEMPLATE.md` — outer frame + slices + hub +
pointer in one PNG. Variants are `jackpot`, `bonus`, `multiplier`,
`pickem`; games without wheels skip this section.
